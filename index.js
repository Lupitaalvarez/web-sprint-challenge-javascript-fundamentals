...
//'nestedFunction' is inside of 'myFunction' where the 'internal' variable was created, which gives 'nestedFunction' access to everything within 'myFunction' this is because of local scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lower = [];
    array.map(function(lowercase){
      return lower.push(lowercase.animal_name.toLowerCase());
    })
    return lower;
    /*Your Code Here*/
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const population = array.filter((animal) => {
...
function multiply(a, b){
  return a * b; // const multiply = (a,b) => a * b;
   /*Your Code Here */
  }
